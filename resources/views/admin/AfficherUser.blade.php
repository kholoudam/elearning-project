                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="d-flex m-2 justify-content-start">
                                <a href="{{ route('utilisateurs.create') }}" class="btn btn-primary d-flex align-items-center gap-2 px-3"
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('utilisateurs.show', $utilisateur->id) }}" class="btn btn-info btn-sm">Voir</a>
