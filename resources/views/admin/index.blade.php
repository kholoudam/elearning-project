            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        {{-- ADMIN cards --}}
                        <div class="row" id="admin-cards">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body fw-bold fs-4">{{ $total_cours }}</div>
                                    <div class="card-footer">Cours</div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-warning text-white mb-4">
                                    <div class="card-body fw-bold fs-4">{{ $total_enseignants }}</div>
                                    <div class="card-footer">Enseignants</div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-success text-white mb-4">
                                    <div class="card-body fw-bold fs-4">{{ $total_etudiants }}</div>
                                    <div class="card-footer">Étudiants</div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-danger text-white mb-4">
                                    <div class="card-body fw-bold fs-4">{{ $total_admin }}</div>
                                    <div class="card-footer">Administrateurs</div>
                                </div>
                            </div>
                        </div>
                        <div class="card mb-4">
