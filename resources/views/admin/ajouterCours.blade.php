            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container">
                        ...
                        <form action="{{ route('coursa.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" id="difficulte" name="difficulte" required>
                                    ...
                                    <option value="débutant" {{ old('difficulte') == 'débutant' ? 'selected' : '' }}>Débutant</option>
                                    <option value="intermédiaire" {{ old('difficulte') == 'intermédiaire' ? 'selected' : '' }}>Intermédiaire</option>
                                    <option value="avancé" {{ old('difficulte') == 'avancé' ? 'selected' : '' }}>Avancé</option>
                                </select>
                            </div>
