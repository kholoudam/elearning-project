    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="{{ route('team') }}" class="nav-item nav-link custom-hover{{ request()->is('team') ? 'active' : '' }}" style="color: rgba(24, 56, 24, 0.7);">Our Team</a>
            ...
            <a href="{{ route('login.show') }}" class="btn py-4 px-lg-5 d-none d-lg-block" style="background-color: rgba(24, 56, 24, 0.7); color: #fff;">Join Now<i class="fa fa-arrow-right ms-3"></i></a>
        </div>
    </nav>
    <!-- Navbar End -->
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center px-3" style="color: rgba(24, 56, 24, 0.7);">Contact Us</h6>
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <div class="d-flex align-items-center mb-3">
                        <div class="d-flex align-items-center justify-content-center flex-shrink-0" style="width: 50px; height: 50px;background-color: rgba(24, 56, 24, 0.7);">
                            <i class="fa fa-map-marker-alt text-white"></i>
                        </div>
                        <div class="ms-3">
                            <h5  style="color: rgba(24, 56, 24, 0.7);">Office</h5>
                    ...
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="ms-3">
                            <h5 style="color: rgba(24, 56, 24, 0.7);">Mobile</h5>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            <h5 style="color: rgba(24, 56, 24, 0.7);"lass="mb-0">info@example.com</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-12 wow fadeInUp" data-wow-delay="0.5s">
                    <form>
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <button class="btn w-100 py-3" style="background-color: rgba(24, 56, 24, 0.7);" type="submit">Send Message</button>
                            </div>
                        </div>
                    </form>
                </div>
