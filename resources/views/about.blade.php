    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                <a href="{{ route('index') }}" class="nav-item nav-link custom-hover {{ request()->is('/') ? 'active' : '' }} ">Home</a>
                <a href="{{ route('about') }}" class="nav-item nav-link custom-hover{{ request()->is('about') ? 'active' : '' }}" style="color: rgba(24, 56, 24, 0.7);">About</a>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <a class="btn py-3 px-5 mt-2" style="background-color:rgba(24, 56, 24, 0.7);color:rgba(255, 255, 255, 0.96);" href="">Read More</a>
                </div>
            </div>
        </div>
    </div>
