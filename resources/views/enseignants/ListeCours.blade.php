                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="d-flex m-2 justify-content-start">
                                <a href="{{ route('cours.create') }}" class="btn btn-primary d-flex align-items-center gap-2 px-3"
                                        ...
                                        @foreach($cours as $index => $c)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="{{ route('cours.destroy', $c->id) }}" method="POST" style="display:inline;">
                                                        @csrf
                                                        @method('DELETE')
